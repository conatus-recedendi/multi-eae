            ...
            optimizer_grouped_parameters = [
                {
                    "params": [
                        ...
                        if n in decay_parameters and "bert" in n
                    ],
                ...
                },
                {
                    "params": [
                        p
                        for n, p in self.model.named_parameters()
                        if n not in decay_parameters and "bert" in n
                    ],
                    "weight_decay": 0.0,
                    "lr": self.args.learning_rate,
                },
                {
                    "params": [
                        p
                        for n, p in self.model.named_parameters()
                        if n in decay_parameters and "bert" not in n
                    ],
                    "weight_decay": self.args.weight_decay,
                ...
                },
                {
                    "params": [
                        p
                        for n, p in self.model.named_parameters()
                        if n not in decay_parameters and "bert" not in n
                    ],
                    "weight_decay": 0.0,
                    "lr": self.not_bert_learning_rate,
                },
